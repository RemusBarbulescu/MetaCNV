...
void mcnvGUI (){
	...
	g_object_set (GTK_BOX ( genderBox ), "margin-top", 15, NULL);
	...
	g_object_set (GTK_BOX ( svChooseBox ), "margin-top", 15, NULL);
	...
	g_object_set (GTK_BOX ( cnRadioBox ), "margin-top", 15, NULL);
	...
	g_object_set (GTK_BOX ( cnChooseBox ), "margin-top", 15, NULL);
	...
	g_object_set (GTK_BOX ( matchRadioBox ), "margin-top", 15, NULL);
	gtk_box_pack_start (GTK_BOX ( matchRadioBox ), matchLabel0, 0, 0, 2);
